export const SOURCES = Object.freeze([
  ...
  { id: "tourism", name: "Lorient Bretagne Sud Tourisme", url: "https://www.lorientbretagnesudtourisme.fr/fr/immanquables/lorient/agenda/spectacle/", homeUrl: "https://www.lorientbretagnesudtourisme.fr/fr/agenda/", adapter: "tourism", pollEveryMinutes: 60, city: null, venue: null, enabled: false, disabledReason: "Les cartes agenda n'exposent que la commune, sans salle ; brancher cette source alerterait aussi le Théâtre de Lorient." },
  ...
  { id: "theatre-lorient", name: "Théâtre de Lorient", url: "https://theatredelorient.fr/saison/", homeUrl: "https://theatredelorient.fr/", adapter: "theatre-lorient", pollEveryMinutes: 15, city: "Lorient", venue: "Théâtre de Lorient", enabled: false, disabledReason: "Hors périmètre demandé ; page HTTP 200 mais signature saison et réservations officielles non extractibles." },
  ...
  { id: "trios", name: "TRIO…S", url: "https://www.vostickets.net/billet?id=TRIO", homeUrl: "https://trio-s.fr/", adapter: "trios", pollEveryMinutes: 15, city: null, venue: "TRIO…S", enabled: false, disabledReason: "Vostickets répond à nouveau, mais les liens de réservation sont en onclick sans URL /billet?SPC exploitable." },
  { id: "fil", name: "Festival Interceltique de Lorient", url: "https://www.festival-interceltique.bzh/billetterie-2026/", homeUrl: "https://www.festival-interceltique.bzh/", adapter: "fil", pollEveryMinutes: 60, city: "Lorient", venue: "Festival Interceltique", enabled: false, disabledReason: "Hors périmètre demandé ; signature reconnue mais aucun événement ni lien de réservation extrait." },
]);
