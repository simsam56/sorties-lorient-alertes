export const SOURCES = Object.freeze([
  ...
  { id: "tourism", name: "Lorient Bretagne Sud Tourisme", url: "https://www.lorientbretagnesudtourisme.fr/fr/immanquables/lorient/agenda/spectacle/", homeUrl: "https://www.lorientbretagnesudtourisme.fr/fr/agenda/", adapter: "tourism", pollEveryMinutes: 60, city: null, venue: null, enabled: true, disabledReason: null },
  ...
  { id: "theatre-lorient", name: "Théâtre de Lorient", url: "https://theatredelorient.fr/saison/", homeUrl: "https://theatredelorient.fr/", adapter: "theatre-lorient", pollEveryMinutes: 15, city: "Lorient", venue: "Théâtre de Lorient", enabled: true, disabledReason: null },
  { id: "hydrophone", name: "Hydrophone", url: "https://www.hydrophone.fr/-La-programmation-2026-.html", homeUrl: "https://www.hydrophone.fr/", adapter: "hydrophone", pollEveryMinutes: 15, city: "Lorient", venue: "Hydrophone", enabled: true, disabledReason: null },
  { id: "trios", name: "TRIO…S", url: "https://www.vostickets.net/billet?id=TRIO", homeUrl: "https://trio-s.fr/", adapter: "trios", pollEveryMinutes: 15, city: null, venue: "TRIO…S", enabled: true, disabledReason: null },
  { id: "fil", name: "Festival Interceltique de Lorient", url: "https://www.festival-interceltique.bzh/billetterie-2026/", homeUrl: "https://www.festival-interceltique.bzh/", adapter: "fil", pollEveryMinutes: 60, city: "Lorient", venue: "Festival Interceltique", enabled: true, disabledReason: null },
]);
